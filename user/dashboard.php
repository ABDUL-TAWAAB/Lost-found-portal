                    ...
                    <table class="styled-table">
                        ...
                        <tbody>
                            <?php foreach ($my_recent_items as $item): ?>
                                <tr>
                                    <td>
                                        <img src="<?php echo $base_path; ?>assets/uploads/<?php echo $item['image']; ?>" alt="Pic" class="table-thumbnail" onerror="this.src='https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80&w=100'">
                                    </td>
